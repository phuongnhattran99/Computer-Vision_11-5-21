...
def display_some_examples(examples, labels):
    ...
    for i in range(25):
        ...
        plt.tight_layout()
        plt.title(str(label), loc = 'center' )
...
if __name__ == "__main__":
    order_test_set("C:/Users/PC/Desktop/miai/ComputerVision/Dataset/Test", "C:/Users/PC/Desktop/miai/ComputerVision/Dataset/Test.csv")
